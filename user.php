...
<body >
	...
	<div class="container">
		...
		<form name="complaint_form" action="twitterapiconnection.php" method="post">
			<div class="row">
				...
				<div class="form-group col-xs-12 col-sm-6 col-lg-8">
					<input class="form-control" type="text" placeholder="Complaint Description" name="complaintdescription" id="complaintdescription">
				</div>
